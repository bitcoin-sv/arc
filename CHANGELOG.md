...
- ARC starts even if ARC cannot initially to the message queue. This is to avoid the scenario where the message queue is down for whatever reason which can lead to ARC getting stuck in a crash loop

...
| 90  | `DOUBLE_SPEND_ATTEMPTED`             | The transaction is a double spend attempt. Competing transaction(s) will be returned with this status. |
| 100   | `SEEN_ON_NETWORK`      | The transaction has been seen on the Bitcoin network and propagated to other nodes. This status is set when metamorph receives an INV message for the transaction from another node than it was sent to. |
| 110  | `MINED`                | The transaction has been mined into a block by a mining node.                                                                                                                                            |
| 120 | `REJECTED`             | The transaction has been rejected by the Bitcoin network.                                                                                                                                                |

// Package blocktx_api provides primitives to interact with the openapi HTTP API.
//
...
func NewClient(server string, opts ...ClientOption) (*Client, error) {
	// create a transactionHandler with sane default values
	client := Client{
		Server: server,
	}
	// mutate transactionHandler and add all optional params
	for _, o := range opts {
...
// The interface specification for the transactionHandler above.
...
// ClientWithResponsesInterface is the interface specification for the transactionHandler with responses above.

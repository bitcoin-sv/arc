...
var _ transactionHandler.TransactionHandler = &TransactionHandlerMock{}
...
func (mock *TransactionHandlerMock) GetTransactionStatus(ctx context.Context, txID string) (*transactionHandler.TransactionStatus, error) {
...
func (mock *TransactionHandlerMock) SubmitTransaction(ctx context.Context, tx []byte, options *arc.TransactionOptions) (*transactionHandler.TransactionStatus, error) {
...
func (mock *TransactionHandlerMock) SubmitTransactions(ctx context.Context, tx [][]byte, options *arc.TransactionOptions) ([]*transactionHandler.TransactionStatus, error) {

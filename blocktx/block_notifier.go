...
func NewBlockNotifier(storeI store.Interface, l *slog.Logger, peerHandler *PeerHandler, peerSettings []config.Peer, network wire.BitcoinNet, opts ...func(notifier *BlockNotifier)) (*BlockNotifier, error) {
	bn := &BlockNotifier{
		storeI: storeI,
		logger: l,

...
func (s *SqLite) RegisterTransaction(ctx context.Context, transaction *blocktx_api.TransactionAndSource) error {
...
func (s *SqLite) RegisterTransactions(ctx context.Context, transactions []*blocktx_api.TransactionAndSource) error {
	start := gocore.CurrentNanos()
	defer func() {

...
func (s *SqLite) SetBlockProcessing(ctx context.Context, hash *chainhash.Hash, setProcessedBy string) (string, error) {
...
func (s *SqLite) DelBlockProcessing(ctx context.Context, hash *chainhash.Hash, processedBy string) error {
	start := gocore.CurrentNanos()
	defer func() {
...
func (s *SqLite) GetBlockHashesProcessingInProgress(ctx context.Context, processedBy string) ([]*chainhash.Hash, error) {
	start := gocore.CurrentNanos()
	defer func() {

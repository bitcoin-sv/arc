...
type CallbackerAPIClient interface {
	...
	RegisterCallback(ctx context.Context, in *Callback, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *callbackerAPIClient) Health(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/callbacker_api.CallbackerAPI/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *callbackerAPIClient) RegisterCallback(ctx context.Context, in *Callback, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/callbacker_api.CallbackerAPI/RegisterCallback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CallbackerAPIServer interface {
	...
	RegisterCallback(context.Context, *Callback) (*emptypb.Empty, error)
...
func (UnimplementedCallbackerAPIServer) RegisterCallback(context.Context, *Callback) (*emptypb.Empty, error) {
...
func _CallbackerAPI_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/callbacker_api.CallbackerAPI/Health",
	}
...
func _CallbackerAPI_RegisterCallback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/callbacker_api.CallbackerAPI/RegisterCallback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

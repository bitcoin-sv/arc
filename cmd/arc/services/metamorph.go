...
func StartMetamorph(logger *slog.Logger, arcConfig *config.ArcConfig, cacheStore cache.Store) (func(), error) {
	...
	processorOpts = append(processorOpts,
		...
		metamorph.WithRejectPendingSeenPending(mtmConfig.RejectPendingSeen.Pending),
		metamorph.WithRejectPendingSeenRequested(mtmConfig.RejectPendingSeen.Requested),

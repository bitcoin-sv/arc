...
func StartMetamorph(logger *slog.Logger, mtmCfg *config.MetamorphConfig, commonCfg *config.CommonConfig) (func(), error) {
	...
	processorOpts = append(processorOpts,
		...
		metamorph.WithReRequestPendingLastConfirmedAgo(mtmCfg.ReRequestPending.LastConfirmedAgo),
		metamorph.WithReRequestPendingSince(mtmCfg.ReRequestPending.PendingSince),
		metamorph.WithReRegisterSeen(mtmCfg.ReRegisterSeen),
		metamorph.WithRejectPending(mtmCfg.RejectPending.Enabled, mtmCfg.RejectPending.LastRequestedAgo, mtmCfg.RejectPending.BlocksSince, mtmCfg.RejectPending.Statuses),

...
the body. In case the client wants to receive all the intermediate status updates about the transaction `X-FullStatusUpdates` header needs to be set to `true`. See the [API documentation](/arc/api.html) for more information.

...
func main() {
	...
	// load the mapi client, with custom options
	var opts []client.Options

	// set the miner ID
	opts = append(opts, client.WithMinerID(&config.MinerIDConfig{
	...
	// Add a an SQL datastore
	opts = append(opts, client.WithSQL(datastore.PostgreSQL, []*datastore.SQLConfig{{

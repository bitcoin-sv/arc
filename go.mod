...
replace github.com/TAAL-GmbH/metamorph => ../metamorph

require (
	github.com/99designs/gqlgen v0.17.20
	github.com/TAAL-GmbH/metamorph v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/ordishs/gocore v1.0.20 // indirect

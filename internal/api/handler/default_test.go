...
func TestNewDefault(t *testing.T) {
	t.Run("simple init", func(t *testing.T) {
		defaultHandler, err := NewDefault(testLogger, "testnet", nil, nil, nil, nil)
...
func TestGETPolicy(t *testing.T) {
	t.Run("default policy", func(t *testing.T) {
		// given
		sut, err := NewDefault(testLogger, "testnet", nil, nil, defaultPolicy, nil)
		require.NoError(t, err)
		e := echo.New()
...
func TestGETHealth(t *testing.T) {
	t.Run("health check success", func(t *testing.T) {
		...
		sut, err := NewDefault(testLogger, "testnet", txHandler, nil, defaultPolicy, nil)
		require.NoError(t, err)
		e := echo.New()
...
func TestGETTransactionStatus(t *testing.T) {
	...
	for _, tc := range tt {
		t.Run(tc.name, func(t *testing.T) {
			...
			defaultHandler, err := NewDefault(testLogger, "testnet", txHandler, nil, nil, nil, WithNow(func() time.Time { return time.Date(2023, 5, 3, 10, 0, 0, 0, time.UTC) }))
			require.NoError(t, err)
...
func TestPOSTTransaction(t *testing.T) { //nolint:funlen
	...
	for _, tc := range tt {
		t.Run(tc.name, func(t *testing.T) {
			...
			require.NoError(t, err)
			sut, err := NewDefault(testLogger, "testnet", txHandler, merkleRootsVerifier, &policy, finder,
...
func TestPOSTTransactions(t *testing.T) { //nolint:funlen
	...
	t.Run("valid tx - missing inputs", func(t *testing.T) {
		...
		sut, err := NewDefault(testLogger, "testnet", txHandler, nil, defaultPolicy, finder)
		require.NoError(t, err)
	...
	t.Run("valid tx - beef", func(t *testing.T) {
		...
		sut, err := NewDefault(testLogger, "testnet", txHandler, merkleRootsVerifier, defaultPolicy, nil)
		require.NoError(t, err)
	...
	t.Run("multiple formats - success", func(t *testing.T) {
		...
		sut, err := NewDefault(testLogger, "testnet", txHandler, merkleRootsVerifier, defaultPolicy, finder)
		require.NoError(t, err)

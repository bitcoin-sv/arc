...
func file_internal_blocktx_blocktx_api_blocktx_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_blocktx_blocktx_api_blocktx_api_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_blocktx_blocktx_api_blocktx_api_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_blocktx_blocktx_api_blocktx_api_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {

...
type CurrentBlockHeightResponse struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	CurrentBlockHeight int64                  `protobuf:"varint,1,opt,name=currentBlockHeight,proto3" json:"currentBlockHeight,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *CurrentBlockHeightResponse) GetCurrentBlockHeight() int64 {
	if x != nil {

...
func TestReorg(t *testing.T) {
	...
	staleBlockHash, expectedTxs := testHandleStaleBlock(t, p2pMsgHandler, blocktxStore, publishedTxs)
	...
	expectedTxs = testHandleReorg(t, p2pMsgHandler, blocktxStore, publishedTxs, staleBlockHash)
	verifyTxs(t, expectedTxs, publishedTxs)
}
...
func testHandleReorg(t *testing.T, p2pMsgHandler *blocktx_p2p.MsgHandler, store *postgresql.PostgreSQL, publishedTxs []*blocktx_api.TransactionBlock, staleBlockHash *chainhash.Hash) []*blocktx_api.TransactionBlock {

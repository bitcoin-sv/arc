...
func TestStartProcessRegisterTxs(t *testing.T) {
	tt := []struct {
		...
		},
		{
			...
			registeredHashes: [][]byte{testutils.Chainhash(t, "ff1374619d6d6a7b30f35560f76a97aa430c016459034afa6d6cbd19a428ce08")[:]},
		...
		},
		{
			...
			getMinedTxs: []store.BlockTransaction{
				{
					TxHash:          testutils.Chainhash(t, "ff1374619d6d6a7b30f35560f76a97aa430c016459034afa6d6cbd19a428ce08")[:],
					BlockHash:       testutils.Chainhash(t, "000000000286022fd64a660ec826def3b9cfc6cfcf3d0c7ee992cc81385fef44")[:],
					BlockHeight:     1661719,
					MerkleTreeIndex: 4,
					BlockStatus:     10,
				},
			...
			getMinedTxs: []store.BlockTransaction{
				{
					...
					MerkleTreeIndex: 4,
					BlockStatus:     10,
					MerkleRoot:      testutils.RevChainhash(t, "d0f2f708a6bddcd2974eb0a3242e1fb38a5ac8139b009b7787c36674f5fc91c9")[:],
				},
			},
		...
		},
		{
			...
			getMinedTxs: []store.BlockTransaction{
				...
				{
					TxHash:          testutils.Chainhash(t, "d828d1d8b8a53c17b6251bc357ff65771b3df5d28b5f009ee97d860b730502d3")[:],
					BlockHash:       testutils.Chainhash(t, "000000000286022fd64a660ec826def3b9cfc6cfcf3d0c7ee992cc81385fef44")[:],
					BlockHeight:     1661719,
					MerkleTreeIndex: 7,
					BlockStatus:     10,
				...
				{
					TxHash:          testutils.Chainhash(t, "07c2c86c79713d62a6a1776ce926f7748b5f763dfda920957ab819d159c00883")[:],
					BlockHash:       testutils.Chainhash(t, "000000000286022fd64a660ec826def3b9cfc6cfcf3d0c7ee992cc81385fef44")[:],
					BlockHeight:     1661719,
					MerkleTreeIndex: 1,
					BlockStatus:     10,

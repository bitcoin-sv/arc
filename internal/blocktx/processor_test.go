...
func TestStartProcessRegisterTxs(t *testing.T) {
	tt := []struct {
		...
		},
		{
			...
			registeredHashes: [][]byte{testutils.RevHexDecodeString(t, "ff1374619d6d6a7b30f35560f76a97aa430c016459034afa6d6cbd19a428ce08")},
		...
		},
		{
			...
			registeredHashes: [][]byte{
				testutils.RevHexDecodeString(t, "ff1374619d6d6a7b30f35560f76a97aa430c016459034afa6d6cbd19a428ce08"),
				testutils.RevHexDecodeString(t, "d828d1d8b8a53c17b6251bc357ff65771b3df5d28b5f009ee97d860b730502d3"),
				testutils.RevHexDecodeString(t, "07c2c86c79713d62a6a1776ce926f7748b5f763dfda920957ab819d159c00883"),
			},
			getBlockTxHashes: []*chainhash.Hash{

...
func TestPostgresDB(t *testing.T) {
	...
	t.Run("get block by height / get chain tip", func(t *testing.T) {
		// given
		prepareDb(t, postgresDB._db, "fixtures/get_block_by_height")
	...
	t.Run("get block gaps", func(t *testing.T) {
		// given
		prepareDb(t, postgresDB._db, "fixtures/get_block_gaps")
	...
	t.Run("get longest chain from height", func(t *testing.T) {
		// given
		prepareDb(t, postgresDB._db, "fixtures/get_longest_chain")
	...
	t.Run("get stale chain back from hash", func(t *testing.T) {
		// given
		prepareDb(t, postgresDB._db, "fixtures/get_stale_chain")
	...
	t.Run("get orphaned chain up from hash", func(t *testing.T) {
		// given
		prepareDb(t, postgresDB._db, "fixtures/get_orphaned_chain")
	...
	t.Run("update blocks statuses", func(t *testing.T) {
		// given
		prepareDb(t, postgresDB._db, "fixtures/update_blocks_statuses")
	...
	t.Run("get mined txs", func(t *testing.T) {
		// given
		prepareDb(t, postgresDB._db, "fixtures/get_transactions")
	...
	t.Run("clear data", func(t *testing.T) {
		prepareDb(t, postgresDB._db, "fixtures/clear_data")
	...
	t.Run("set/get/del block processing", func(t *testing.T) {
		prepareDb(t, postgresDB._db, "fixtures/block_processing")
	...
	t.Run("mark block as done", func(t *testing.T) {
		// given
		prepareDb(t, postgresDB._db, "fixtures/mark_block_as_done")
	...
	t.Run("verify merkle roots", func(t *testing.T) {
		// given
		prepareDb(t, postgresDB._db, "fixtures/verify_merkle_roots")
...
func TestPostgresStore_UpsertBlockTransactions(t *testing.T) {
	...
	for _, tc := range tcs {
		t.Run(tc.name, func(t *testing.T) {
			// given
			prepareDb(t, sut._db, "fixtures/upsert_block_transactions")
...
func TestPostgresStore_RegisterTransactions(t *testing.T) {
	...
	for _, tc := range tcs {
		t.Run(tc.name, func(t *testing.T) {
			// given
			prepareDb(t, sut._db, "fixtures/register_transactions")

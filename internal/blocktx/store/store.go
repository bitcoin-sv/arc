...
type BlocktxStore interface {
	RegisterTransactions(ctx context.Context, txHashes [][]byte) (err error)
	...
	InsertBlockTransactions(ctx context.Context, blockID uint64, txsWithMerklePaths []TxWithMerklePath) error

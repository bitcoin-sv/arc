...
func (b *UTXOConsolidator) Start() error {
	...
	_, unconfirmed, err := b.utxoClient.GetBalanceWithRetries(b.ctx, !b.isTestnet, b.keySet.Address(!b.isTestnet), 1*time.Second, 5)
	if err != nil {
	...
	utxos, err := b.utxoClient.GetUTXOsWithRetries(b.ctx, !b.isTestnet, b.keySet.Script, b.keySet.Address(!b.isTestnet), 1*time.Second, 5)
	if err != nil {

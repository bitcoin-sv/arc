...
type HealthResponse struct {
	...
	Nats      uint64                 `protobuf:"varint,2,opt,name=nats,proto3" json:"nats,omitempty"`
}
...
func (x *HealthResponse) GetNats() uint64 {
	if x != nil {
		return x.Nats
	}
	return 0
...
var file_internal_callbacker_callbacker_api_callbacker_api_proto_rawDesc = []byte{
	...
	0x04, 0x52, 0x04, 0x6e, 0x61, 0x74, 0x73, 0x22, 0xfe, 0x02, 0x0a, 0x0b, 0x53, 0x65, 0x6e, 0x64,

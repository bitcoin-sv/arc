...
var file_internal_callbacker_callbacker_api_callbacker_api_proto_rawDesc = []byte{
	...
	0x05, 0x4d, 0x49, 0x4e, 0x45, 0x44, 0x10, 0x78, 0x32, 0xf9, 0x01, 0x0a, 0x0d, 0x43, 0x61, 0x6c,
	...
	0x74, 0x79, 0x22, 0x00, 0x42, 0x12, 0x5a, 0x10, 0x2e, 0x3b, 0x63, 0x61, 0x6c, 0x6c, 0x62, 0x61,
	0x63, 0x6b, 0x65, 0x72, 0x5f, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_internal_callbacker_callbacker_api_callbacker_api_proto_goTypes = []any{
	...
	(*DeleteURLMappingRequest)(nil), // 4: callbacker_api.DeleteURLMappingRequest
...
var file_internal_callbacker_callbacker_api_callbacker_api_proto_depIdxs = []int32{
	...
	4, // 8: callbacker_api.CallbackerAPI.DeleteURLMapping:input_type -> callbacker_api.DeleteURLMappingRequest
	...
	7, // 11: callbacker_api.CallbackerAPI.DeleteURLMapping:output_type -> google.protobuf.Empty
...
func file_internal_callbacker_callbacker_api_callbacker_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_callbacker_callbacker_api_callbacker_api_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*DeleteURLMappingRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

...
// Ensure, that CallbackerAPIClientMock does implement CallbackerAPIClient.
// If this is not the case, regenerate this file with moq.
var _ CallbackerAPIClient = &CallbackerAPIClientMock{}

// CallbackerAPIClientMock is a mock implementation of CallbackerAPIClient.
//
//	func TestSomethingThatUsesCallbackerAPIClient(t *testing.T) {
//
//		// make and configure a mocked CallbackerAPIClient
//		mockedCallbackerAPIClient := &CallbackerAPIClientMock{
//			HealthFunc: func(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
//				panic("mock out the Health method")
//			},
//			SendCallbackFunc: func(ctx context.Context, in *SendCallbackRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
//				panic("mock out the SendCallback method")
//			},
//		}
//
//		// use mockedCallbackerAPIClient in code that requires CallbackerAPIClient
...
func (mock *CallbackerAPIClientMock) Health(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
...
func (mock *CallbackerAPIClientMock) SendCallback(ctx context.Context, in *SendCallbackRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {

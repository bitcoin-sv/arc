...
//go:generate moq -skip-ensure -pkg mocks -out ./mocks/sender_mock.go ./ SenderI
...
//go:generate moq -skip-ensure -pkg mocks -out ./mocks/health_watch_server_mock.go ./ HealthWatchServer

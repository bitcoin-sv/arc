...
func (mock *ProcessorIMock) Dispatch(url string, dto *callbacker.CallbackEntry) {
	//TODO implement me
	panic("implement me")
}

func (mock *ProcessorIMock) DeleteURLMappingsExcept(ctx context.Context, except []string) (rowsAffected int64, err error) {
	//TODO implement me
	panic("implement me")
}

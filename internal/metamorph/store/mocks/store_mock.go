...
//			},
//			GetFunc: func(ctx context.Context, key []byte) (*global.Data, error) {
//				panic("mock out the Get method")
//			},
//			GetDoubleSpendTxsFunc: func(ctx context.Context, older time.Time) ([]*global.Data, error) {
//				panic("mock out the GetDoubleSpendTxs method")
//			},
//			GetManyFunc: func(ctx context.Context, keys [][]byte) ([]*global.Data, error) {
...
//			},
//			GetSeenFunc: func(ctx context.Context, fromDuration time.Duration, toDuration time.Duration, limit int64, offset int64) ([]*global.Data, error) {
//				panic("mock out the GetSeen method")
//			},
//			GetSeenPendingFunc: func(ctx context.Context, lastSubmittedSince time.Duration, confirmedAgo time.Duration, seenAgo time.Duration, limit int64, offset int64) ([]*global.Data, error) {
...
//			},
//			GetUnseenFunc: func(ctx context.Context, since time.Time, limit int64, offset int64) ([]*global.Data, error) {
...
//			},
//			SetFunc: func(ctx context.Context, value *global.Data) error {
//				panic("mock out the Set method")
//			},
//			SetBulkFunc: func(ctx context.Context, data []*global.Data) error {
...
//			},
//			UpdateDoubleSpendFunc: func(ctx context.Context, updates []store.UpdateStatus, updateCompetingTxs bool) ([]*global.Data, error) {
//				panic("mock out the UpdateDoubleSpend method")
//			},
//			UpdateMinedFunc: func(ctx context.Context, txsBlocks []*blocktx_api.TransactionBlock) ([]*global.Data, error) {
//				panic("mock out the UpdateMined method")
//			},
//			UpdateStatusFunc: func(ctx context.Context, updates []store.UpdateStatus) ([]*global.Data, error) {
...
type MetamorphStoreMock struct {
	...
	calls struct {
		...
		UpdateDoubleSpend []struct {
			...
			// UpdateCompetingTxs is the updateCompetingTxs argument value.
			UpdateCompetingTxs bool
		}
...
// Get calls GetFunc.
func (mock *MetamorphStoreMock) Get(ctx context.Context, key []byte) (*global.Data, error) {
	if mock.GetFunc == nil {
...
func (mock *MetamorphStoreMock) GetDoubleSpendTxs(ctx context.Context, older time.Time) ([]*global.Data, error) {
...
func (mock *MetamorphStoreMock) GetMany(ctx context.Context, keys [][]byte) ([]*global.Data, error) {
...
func (mock *MetamorphStoreMock) GetSeen(ctx context.Context, fromDuration time.Duration, toDuration time.Duration, limit int64, offset int64) ([]*global.Data, error) {
...
func (mock *MetamorphStoreMock) GetSeenPending(ctx context.Context, lastSubmittedSince time.Duration, confirmedAgo time.Duration, seenAgo time.Duration, limit int64, offset int64) ([]*global.Data, error) {
...
func (mock *MetamorphStoreMock) GetUnseen(ctx context.Context, since time.Time, limit int64, offset int64) ([]*global.Data, error) {
...
// Set calls SetFunc.
func (mock *MetamorphStoreMock) Set(ctx context.Context, value *global.Data) error {
	if mock.SetFunc == nil {
...
func (mock *MetamorphStoreMock) SetBulk(ctx context.Context, data []*global.Data) error {
...
func (mock *MetamorphStoreMock) UpdateDoubleSpend(ctx context.Context, updates []store.UpdateStatus, updateCompetingTxs bool) ([]*global.Data, error) {
	...
	callInfo := struct {
		...
		Ctx:                ctx,
		Updates:            updates,
		UpdateCompetingTxs: updateCompetingTxs,
	}
	...
	return mock.UpdateDoubleSpendFunc(ctx, updates, updateCompetingTxs)
}
...
func (mock *MetamorphStoreMock) UpdateMined(ctx context.Context, txsBlocks []*blocktx_api.TransactionBlock) ([]*global.Data, error) {
...
func (mock *MetamorphStoreMock) UpdateStatus(ctx context.Context, updates []store.UpdateStatus) ([]*global.Data, error) {

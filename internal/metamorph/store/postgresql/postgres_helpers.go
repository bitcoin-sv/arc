...
func getStoreDataFromRows(rows *sql.Rows) ([]*store.TransactionData, error) {
	var storeData []*store.TransactionData
...
func getStoreDataFromRow(rows *sql.Rows, data *store.TransactionData) (*store.TransactionData, error) {

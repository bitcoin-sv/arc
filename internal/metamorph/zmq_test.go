...
func TestNewZMQHandlers(t *testing.T) {
	...
	*/
	...
	_ = handler1.Subscribe(ZmqFirstTopic, messages)
	_ = handler2.Subscribe(ZmqFirstTopic, messages)
	_ = handler3.Subscribe(ZmqFirstTopic, messages)
	...
	_ = handler1.Subscribe(ZmqSecondTopic, messages)

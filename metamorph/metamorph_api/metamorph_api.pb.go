...
type SetUnlockedByNameResponse struct {
	...
	RecordsAffected int32 `protobuf:"varint,1,opt,name=records_affected,json=recordsAffected,proto3" json:"records_affected,omitempty"`
}
...
func (x *SetUnlockedByNameResponse) GetRecordsAffected() int32 {
	if x != nil {

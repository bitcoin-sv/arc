...
var file_pkg_message_queue_nats_client_test_api_test_api_proto_rawDesc = []byte{
...
var (
	...
	file_pkg_message_queue_nats_client_test_api_test_api_proto_rawDescData = file_pkg_message_queue_nats_client_test_api_test_api_proto_rawDesc
)
...
func file_pkg_message_queue_nats_client_test_api_test_api_proto_rawDescGZIP() []byte {
	file_pkg_message_queue_nats_client_test_api_test_api_proto_rawDescOnce.Do(func() {
		file_pkg_message_queue_nats_client_test_api_test_api_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_message_queue_nats_client_test_api_test_api_proto_rawDescData)
	})
...
func file_pkg_message_queue_nats_client_test_api_test_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_message_queue_nats_client_test_api_test_api_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_message_queue_nats_client_test_api_test_api_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_pkg_message_queue_nats_client_test_api_test_api_proto_rawDesc = nil

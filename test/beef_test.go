...
func TestBeef_Fail(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expectedErrMsgDetail: "Fees are too low", // this doesn't seem like the right error message given the name of the test
		},
		{
			...
			expectedErrCode:      int(api.ErrStatusFees),
			expectedErrMsgDetail: "Fees paid by 5ef36123528b73da1bba4f329ef615188a9d8bedeadfd379c387a6d41c5042e2 are insufficient.",
		},
	}

...
func TestBeef_Fail(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expectedErrCode:      469,
			expectedErrMsgDetail: "BEEF validation failed: couldn't validate Merkle Roots",
			expectedErrTxID:      "2d697c7ebe8f7c6c76caad4aecd52962002e9820a86724d517f0b6c2aa6a0312",
		},
	}
